...
export default function CareersHero({ onButtonClick }: CareerPathProps) {
  return (
    <S.SectionRoot>
      <PageContainer>
        <S.StackContainer>
          <S.Title variant="h2">Build Your Career path with us</S.Title>

          <S.Subtitle>
            We offer remote and on-site opportunities in design and development,
            open to talent across the country. If you value ownership and
          ...
          <S.ActionAndVideoArea>
            <Box sx={{ flexShrink: 0 }}>
              <DiscoverButton
                ...
                aria-label="Browse current job opportunities"
