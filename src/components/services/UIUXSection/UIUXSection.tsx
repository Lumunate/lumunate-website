                ...
                <ContentBox>
                    ...
                    >
                        ...
                        <List sx={{ pl: 4 }}>
                            ...
                            <CustomListItem>
                                Used AI-assisted iterations to explore and refine layouts quickly
                            </CustomListItem>
                        </List>
                    </Box>
                    ...
                    <Box sx={{ display: { xs: "none", md: "block" } }}>
                        <Stack direction="row" spacing="10px" alignItems="center">
                            ...
                            <ToolIcon src="/services/lovable.png" alt="Lovable" width={80} height={40} />
                            <ToolIcon src="/services/figma.png" alt="Figma" width={80} height={40} />
                        </Stack>
                    </Box>
