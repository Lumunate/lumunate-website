...
const projects = [
  {
    name: "Airbot – AI-Powered Hospitality Assistant",
    href: "/projects/airbot",
  },
  {
    name: "Koinfolio – Cryptocurrency Portfolio Manager",
    href: "/projects/koinfolio",
  },
  { name: "Allfred – Healthcare ERP", href: "/projects/allfred" },
  {
    name: "Cut Connect – Men’s Grooming SaaS Platform",
    href: "/projects/cut-connect",
  },
  {
    name: "TCR Properties – Real-estate Management",
    href: "/projects/tcr-properties",
  },
  {
    name: "Scoplex – Science-led skincare E-commerce",
    href: "/projects/scoplex",
  },
  ...
  {
    name: "XS Uniforms – Automated Garment Sizing Tool",
    href: "/projects/xs-uniforms",
  },
];
...
const services = [
  ...
  { name: "Enterprise Solutions", href: "/services/enterprise-solutions" },
  {
    ...
    href: "/services/digital-marketing-transformation",
  },
];
  ...
  useEffect(() => {
    const calcMenuMetrics = () => {
      if (
        ...
        !logoBoxRef.current ||
        !caseStudiesRightDividerRef.current
      )
        return;
      const navRect = navContainerRef.current.getBoundingClientRect();
      const logoRect = logoBoxRef.current.getBoundingClientRect();
      const dividerRect =
        caseStudiesRightDividerRef.current.getBoundingClientRect();
    ...
    if (isProjectsOpen || isServicesOpen)
      ...
      <Toolbar sx={{ opacity: 1, visibility: "visible" }}>
        <NavContainer ref={navContainerRef}>
          <StyledToolbar disableGutters>
            <LogoBox ref={logoBoxRef} aria-label="Lumunate Home">
              <Logo />
            </LogoBox>
            ...
            >
                  ...
                  <ListItemText
                    ...
                    primaryTypographyProps={{
                      sx: {
                        ...
                        color: isActive("/")
                          ? theme.palette.common.white
                          : theme.palette.navbar.mobileItem,
              ...
              <Box>
                <Button
                  ...
                  target="_blank"
                  endIcon={
                    <ArrowOutwardIcon sx={{ fontSize: "20px !important" }} />
                  }
                  sx={{
                    ...navButtonSx,
                    color: theme.palette.common.white,
